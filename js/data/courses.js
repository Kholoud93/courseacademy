...
const detailById = {
  ...
  202: {
    ...
    instructorAvatar: "assets/images/instructor-ahmed-shamri.png",
    heroInstructorAvatar: "assets/images/instructor-ahmed-shamri-hero.png",
...
export function getCurriculumForCourse(id) {
  return curriculumByCourse[Number(id)] || curriculumByCourse[202];
}

/** @deprecated استخدم getCurriculumForCourse */
export const curriculum = curriculumByCourse[202];
